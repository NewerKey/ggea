...
async def http_exc_400_bad_request(error_msg: str) -> Exception:
    """
...
async def http_exc_401_unauthorized_request(error_msg: str) -> Exception:
    """
...
async def http_exc_403_forbidden_request(error_msg: str) -> Exception:
    """
...
async def http_exc_404_resource_not_found(error_msg: str) -> Exception:
    """
